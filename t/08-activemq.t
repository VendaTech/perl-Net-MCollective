...
use_ok('Net::MCollective::Connector::ActiveMQ');
...
my $c = Net::MCollective::Connector::ActiveMQ->new(
    _client => _mock_stomp(),
...
$c = Net::MCollective::Connector::ActiveMQ->new(
    _client => _mock_stomp(),
...
sub _mock_stomp {
    ...
    return MockActiveMQ->meta->new_object;
}
